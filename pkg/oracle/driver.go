...
//
// int OracleArrayStreamGetSchema(struct ArrowArrayStream*, struct ArrowSchema*);
// int OracleArrayStreamGetNext(struct ArrowArrayStream*, struct ArrowArray*);
// const char* OracleArrayStreamGetLastError(struct ArrowArrayStream*);
// void OracleArrayStreamRelease(struct ArrowArrayStream*);
//
// int OracleArrayStreamGetSchemaTrampoline(struct ArrowArrayStream*, struct ArrowSchema*);
// int OracleArrayStreamGetNextTrampoline(struct ArrowArrayStream*, struct ArrowArray*);
//
...
import (
	...
	oracle "github.com/gizmodata/adbc-driver-oracle/driver/oracle"
)

// Must use malloc() to respect CGO rules
var drv = oracle.NewDriver(mallocator.NewMallocator())
...
const errPrefix = "[Oracle] "
const logLevelEnvVar = "ADBC_DRIVER_DB2_LOG_LEVEL"
...
func setErr(err *C.struct_AdbcError, format string, vals ...interface{}) {
	...
	err.release = (*[0]byte)(C.Oracle_release_error)
}
...
func setErrWithDetails(err *C.struct_AdbcError, adbcError adbc.Error) {
	...
	cErrPtr := C.calloc(C.sizeof_struct_OracleError, C.size_t(1))
	cErr := (*C.struct_OracleError)(cErrPtr)
	cErr.message = C.CString(adbcError.Msg)
	err.message = cErr.message
	err.release = (*[0]byte)(C.OracleReleaseErrWithDetails)
...
func poison(err *C.struct_AdbcError, fname string, e interface{}) C.AdbcStatusCode {
	if !globalPoison.Swap(true) {
		...
		fmt.Fprintf(os.Stderr, "Oracle driver panicked, stack traces:\n%s", buf[:length])
	}
	setErr(err, "%s: Go panic in Oracle driver (see stderr): %#v", fname, e)
...
func initLoggingFromEnv(db adbc.Database) {
	...
	if !ok {
		logger.Error("Oracle does not support logging")
		return
	}
...
func printLoggingHelp() {
	fmt.Fprintf(os.Stderr, "Oracle: to enable logging, set %s to 'debug', 'info', 'warn', or 'error'", logLevelEnvVar)
}
...
func (cStream *cArrayStream) maybeError() C.int {
	...
	if err != nil {
		if cStream.adbcErr != nil {
			C.OracleerrRelease(cStream.adbcErr)
		} else {
...
//export OracleArrayStreamGetLastError
func OracleArrayStreamGetLastError(stream *C.struct_ArrowArrayStream) *C.cchar_t {
	if stream == nil || stream.release != (*[0]byte)(C.OracleArrayStreamRelease) || stream.private_data == nil {
		return nil
	}
...
//export OracleArrayStreamGetNext
func OracleArrayStreamGetNext(stream *C.struct_ArrowArrayStream, array *C.struct_ArrowArray) C.int {
	if stream == nil || stream.release != (*[0]byte)(C.OracleArrayStreamRelease) || stream.private_data == nil {
		return C.EINVAL
	}
	cStream := getFromHandle[cArrayStream](stream.private_data)
...
//export OracleArrayStreamGetSchema
func OracleArrayStreamGetSchema(stream *C.struct_ArrowArrayStream, schema *C.struct_ArrowSchema) C.int {
	if stream == nil || stream.release != (*[0]byte)(C.OracleArrayStreamRelease) || stream.private_data == nil {
		return C.EINVAL
	}
	cStream := getFromHandle[cArrayStream](stream.private_data)
...
//export OracleArrayStreamRelease
func OracleArrayStreamRelease(stream *C.struct_ArrowArrayStream) {
	if stream == nil || stream.release != (*[0]byte)(C.OracleArrayStreamRelease) || stream.private_data == nil {
		return
	}
...
//export OracleErrorFromArrayStream
func OracleErrorFromArrayStream(stream *C.struct_ArrowArrayStream, status *C.AdbcStatusCode) *C.struct_AdbcError {
	if stream == nil || stream.release != (*[0]byte)(C.OracleArrayStreamRelease) || stream.private_data == nil {
		return nil
	}
	cStream := getFromHandle[cArrayStream](stream.private_data)
...
func exportRecordReader(rdr array.RecordReader, stream *C.struct_ArrowArrayStream) {
	...
	stream.get_last_error = (*[0]byte)(C.OracleArrayStreamGetLastError)
	stream.get_next = (*[0]byte)(C.OracleArrayStreamGetNextTrampoline)
	stream.get_schema = (*[0]byte)(C.OracleArrayStreamGetSchemaTrampoline)
	stream.release = (*[0]byte)(C.OracleArrayStreamRelease)
...
//export OracleDatabaseGetOption
func OracleDatabaseGetOption(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.char, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleDatabaseGetOptionBytes
func OracleDatabaseGetOptionBytes(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.uint8_t, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleDatabaseGetOptionDouble
func OracleDatabaseGetOptionDouble(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleDatabaseGetOptionInt
func OracleDatabaseGetOptionInt(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleDatabaseInit
func OracleDatabaseInit(db *C.struct_AdbcDatabase, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleDatabaseNew
func OracleDatabaseNew(db *C.struct_AdbcDatabase, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleDatabaseRelease
func OracleDatabaseRelease(db *C.struct_AdbcDatabase, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
			code = poison(err, "AdbcDatabaseInit", e)
		}
...
//export OracleDatabaseSetOption
func OracleDatabaseSetOption(db *C.struct_AdbcDatabase, key, value *C.cchar_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleDatabaseSetOptionBytes
func OracleDatabaseSetOptionBytes(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.cuint8_t, length C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleDatabaseSetOptionDouble
func OracleDatabaseSetOptionDouble(db *C.struct_AdbcDatabase, key *C.cchar_t, value C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleDatabaseSetOptionInt
func OracleDatabaseSetOptionInt(db *C.struct_AdbcDatabase, key *C.cchar_t, value C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleConnectionGetOption
func OracleConnectionGetOption(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.char, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleConnectionGetOptionBytes
func OracleConnectionGetOptionBytes(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.uint8_t, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleConnectionGetOptionDouble
func OracleConnectionGetOptionDouble(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleConnectionGetOptionInt
func OracleConnectionGetOptionInt(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleConnectionNew
func OracleConnectionNew(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleConnectionSetOption
func OracleConnectionSetOption(cnxn *C.struct_AdbcConnection, key, val *C.cchar_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleConnectionSetOptionBytes
func OracleConnectionSetOptionBytes(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.cuint8_t, length C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleConnectionSetOptionDouble
func OracleConnectionSetOptionDouble(db *C.struct_AdbcConnection, key *C.cchar_t, value C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleConnectionSetOptionInt
func OracleConnectionSetOptionInt(db *C.struct_AdbcConnection, key *C.cchar_t, value C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleConnectionInit
func OracleConnectionInit(cnxn *C.struct_AdbcConnection, db *C.struct_AdbcDatabase, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleConnectionRelease
func OracleConnectionRelease(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleConnectionCancel
func OracleConnectionCancel(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleConnectionGetInfo
func OracleConnectionGetInfo(cnxn *C.struct_AdbcConnection, codes *C.cuint32_t, len C.size_t, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleConnectionGetObjects
func OracleConnectionGetObjects(cnxn *C.struct_AdbcConnection, depth C.int, catalog, dbSchema, tableName *C.cchar_t, tableType **C.cchar_t, columnName *C.cchar_t,
...
//export OracleConnectionGetStatistics
func OracleConnectionGetStatistics(cnxn *C.struct_AdbcConnection, catalog, dbSchema, tableName *C.cchar_t, approximate C.char, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleConnectionGetStatisticNames
func OracleConnectionGetStatisticNames(cnxn *C.struct_AdbcConnection, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
			code = poison(err, "AdbcConnectionGetStatistics", e)
		}
...
//export OracleConnectionGetTableSchema
func OracleConnectionGetTableSchema(cnxn *C.struct_AdbcConnection, catalog, dbSchema, tableName *C.cchar_t, schema *C.struct_ArrowSchema, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleConnectionGetTableTypes
func OracleConnectionGetTableTypes(cnxn *C.struct_AdbcConnection, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleConnectionReadPartition
func OracleConnectionReadPartition(cnxn *C.struct_AdbcConnection, serialized *C.cuint8_t, serializedLen C.size_t, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleConnectionCommit
func OracleConnectionCommit(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleConnectionRollback
func OracleConnectionRollback(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleStatementGetOption
func OracleStatementGetOption(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.char, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleStatementGetOptionBytes
func OracleStatementGetOptionBytes(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.uint8_t, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleStatementGetOptionDouble
func OracleStatementGetOptionDouble(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleStatementGetOptionInt
func OracleStatementGetOptionInt(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleStatementNew
func OracleStatementNew(cnxn *C.struct_AdbcConnection, stmt *C.struct_AdbcStatement, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleStatementRelease
func OracleStatementRelease(stmt *C.struct_AdbcStatement, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleStatementCancel
func OracleStatementCancel(stmt *C.struct_AdbcStatement, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleStatementPrepare
func OracleStatementPrepare(stmt *C.struct_AdbcStatement, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleStatementExecuteQuery
func OracleStatementExecuteQuery(stmt *C.struct_AdbcStatement, out *C.struct_ArrowArrayStream, affected *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleStatementExecuteSchema
func OracleStatementExecuteSchema(stmt *C.struct_AdbcStatement, schema *C.struct_ArrowSchema, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
			code = poison(err, "AdbcStatementExecuteQuery", e)
		}
...
//export OracleStatementSetSqlQuery
func OracleStatementSetSqlQuery(stmt *C.struct_AdbcStatement, query *C.cchar_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleStatementSetSubstraitPlan
func OracleStatementSetSubstraitPlan(stmt *C.struct_AdbcStatement, plan *C.cuint8_t, length C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleStatementBind
func OracleStatementBind(stmt *C.struct_AdbcStatement, values *C.struct_ArrowArray, schema *C.struct_ArrowSchema, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleStatementBindStream
func OracleStatementBindStream(stmt *C.struct_AdbcStatement, stream *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleStatementGetParameterSchema
func OracleStatementGetParameterSchema(stmt *C.struct_AdbcStatement, schema *C.struct_ArrowSchema, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleStatementSetOption
func OracleStatementSetOption(stmt *C.struct_AdbcStatement, key, value *C.cchar_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleStatementSetOptionBytes
func OracleStatementSetOptionBytes(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.cuint8_t, length C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleStatementSetOptionDouble
func OracleStatementSetOptionDouble(db *C.struct_AdbcStatement, key *C.cchar_t, value C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleStatementSetOptionInt
func OracleStatementSetOptionInt(db *C.struct_AdbcStatement, key *C.cchar_t, value C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export OracleStatementExecutePartitions
func OracleStatementExecutePartitions(stmt *C.struct_AdbcStatement, schema *C.struct_ArrowSchema, partitions *C.struct_AdbcPartitions, affected *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export AdbcDriverOracleInit
func AdbcDriverOracleInit(version C.int, rawDriver *C.void, err *C.struct_AdbcError) C.AdbcStatusCode {
	...
	driver.DatabaseInit = (*[0]byte)(C.OracleDatabaseInit)
	driver.DatabaseNew = (*[0]byte)(C.OracleDatabaseNew)
	driver.DatabaseRelease = (*[0]byte)(C.OracleDatabaseRelease)
	driver.DatabaseSetOption = (*[0]byte)(C.OracleDatabaseSetOption)

	driver.ConnectionNew = (*[0]byte)(C.OracleConnectionNew)
	driver.ConnectionInit = (*[0]byte)(C.OracleConnectionInit)
	driver.ConnectionRelease = (*[0]byte)(C.OracleConnectionRelease)
	driver.ConnectionSetOption = (*[0]byte)(C.OracleConnectionSetOption)
	driver.ConnectionGetInfo = (*[0]byte)(C.OracleConnectionGetInfo)
	driver.ConnectionGetObjects = (*[0]byte)(C.OracleConnectionGetObjects)
	driver.ConnectionGetTableSchema = (*[0]byte)(C.OracleConnectionGetTableSchema)
	driver.ConnectionGetTableTypes = (*[0]byte)(C.OracleConnectionGetTableTypes)
	driver.ConnectionReadPartition = (*[0]byte)(C.OracleConnectionReadPartition)
	driver.ConnectionCommit = (*[0]byte)(C.OracleConnectionCommit)
	driver.ConnectionRollback = (*[0]byte)(C.OracleConnectionRollback)

	driver.StatementNew = (*[0]byte)(C.OracleStatementNew)
	driver.StatementRelease = (*[0]byte)(C.OracleStatementRelease)
	driver.StatementSetOption = (*[0]byte)(C.OracleStatementSetOption)
	driver.StatementSetSqlQuery = (*[0]byte)(C.OracleStatementSetSqlQuery)
	driver.StatementSetSubstraitPlan = (*[0]byte)(C.OracleStatementSetSubstraitPlan)
	driver.StatementBind = (*[0]byte)(C.OracleStatementBind)
	driver.StatementBindStream = (*[0]byte)(C.OracleStatementBindStream)
	driver.StatementExecuteQuery = (*[0]byte)(C.OracleStatementExecuteQuery)
	driver.StatementExecutePartitions = (*[0]byte)(C.OracleStatementExecutePartitions)
	driver.StatementGetParameterSchema = (*[0]byte)(C.OracleStatementGetParameterSchema)
	driver.StatementPrepare = (*[0]byte)(C.OracleStatementPrepare)

	if version == C.ADBC_VERSION_1_1_0 {
		driver.ErrorGetDetailCount = (*[0]byte)(C.OracleErrorGetDetailCount)
		driver.ErrorGetDetail = (*[0]byte)(C.OracleErrorGetDetail)
		driver.ErrorFromArrayStream = (*[0]byte)(C.OracleErrorFromArrayStream)

		driver.DatabaseGetOption = (*[0]byte)(C.OracleDatabaseGetOption)
		driver.DatabaseGetOptionBytes = (*[0]byte)(C.OracleDatabaseGetOptionBytes)
		driver.DatabaseGetOptionDouble = (*[0]byte)(C.OracleDatabaseGetOptionDouble)
		driver.DatabaseGetOptionInt = (*[0]byte)(C.OracleDatabaseGetOptionInt)
		driver.DatabaseSetOptionBytes = (*[0]byte)(C.OracleDatabaseSetOptionBytes)
		driver.DatabaseSetOptionDouble = (*[0]byte)(C.OracleDatabaseSetOptionDouble)
		driver.DatabaseSetOptionInt = (*[0]byte)(C.OracleDatabaseSetOptionInt)

		driver.ConnectionCancel = (*[0]byte)(C.OracleConnectionCancel)
		driver.ConnectionGetOption = (*[0]byte)(C.OracleConnectionGetOption)
		driver.ConnectionGetOptionBytes = (*[0]byte)(C.OracleConnectionGetOptionBytes)
		driver.ConnectionGetOptionDouble = (*[0]byte)(C.OracleConnectionGetOptionDouble)
		driver.ConnectionGetOptionInt = (*[0]byte)(C.OracleConnectionGetOptionInt)
		driver.ConnectionGetStatistics = (*[0]byte)(C.OracleConnectionGetStatistics)
		driver.ConnectionGetStatisticNames = (*[0]byte)(C.OracleConnectionGetStatisticNames)
		driver.ConnectionSetOptionBytes = (*[0]byte)(C.OracleConnectionSetOptionBytes)
		driver.ConnectionSetOptionDouble = (*[0]byte)(C.OracleConnectionSetOptionDouble)
		driver.ConnectionSetOptionInt = (*[0]byte)(C.OracleConnectionSetOptionInt)

		driver.StatementCancel = (*[0]byte)(C.OracleStatementCancel)
		driver.StatementExecuteSchema = (*[0]byte)(C.OracleStatementExecuteSchema)
		driver.StatementGetOption = (*[0]byte)(C.OracleStatementGetOption)
		driver.StatementGetOptionBytes = (*[0]byte)(C.OracleStatementGetOptionBytes)
		driver.StatementGetOptionDouble = (*[0]byte)(C.OracleStatementGetOptionDouble)
		driver.StatementGetOptionInt = (*[0]byte)(C.OracleStatementGetOptionInt)
		driver.StatementSetOptionBytes = (*[0]byte)(C.OracleStatementSetOptionBytes)
		driver.StatementSetOptionDouble = (*[0]byte)(C.OracleStatementSetOptionDouble)
		driver.StatementSetOptionInt = (*[0]byte)(C.OracleStatementSetOptionInt)
	}
